...
DEBIAN="libnl-dev,isc-dhcp-server,tinyproxy,libssl-dev,apache2,macchanger,python-dnspython,python-pcapy,dsniff,stunnel4,python-scapy,sslsplit"
...
AFTER_COMMANDS="git clone --depth 1 https://github.com/sensepost/mana,cd {INSTALL_LOCATION},git submodule init,git submodule update,make,make install"
